/**
 * Renovação Servidor 3 - 12 Meses CORRETO
 * 
...
async function renovar12MesesServidor3(clienteId) {
    console.log('🎯 RENOVAÇÃO SERVIDOR 3 - 12 MESES CORRETO');
    console.log(`🎯 Cliente: ${clienteId}`);
    console.log(`📅 Período: 12 meses (ANUAL COMPLETO)`);
    ...
    try {
        ...
        if (renewBtn) {
            ...
            // SELEÇÃO DO PLANO DE 12 MESES
            log('🎯 INICIANDO SELEÇÃO DO PLANO DE 12 MESES', 'info');
            ...
            if (packageDropdown) {
                ...
                if (opcaoAtual.includes('ANUAL') || opcaoAtual.includes('12') || opcaoAtual === 'Não encontrada') {
                    ...
                    // Tentar encontrar "ANUAL COMPLETO" diretamente
                    ...
                    for (let i = 0; i < opcoes.length; i++) {
                        ...
                        if (texto && (texto.includes('ANUAL COMPLETO') || 
                                     texto.includes('ANUAL') || 
                                     texto.includes('12 MÊS') || 
                                     texto.includes('12'))) {
        ...
        console.log('');
        console.log('🎉 RENOVAÇÃO DE 12 MESES SERVIDOR 3 CONCLUÍDA!');
        console.log(`🎯 Cliente: ${clienteId}`);
        console.log(`📅 Período: 12 meses (ANUAL COMPLETO)`);
...
if (!clienteId) {
    ...
    console.log('📖 Uso: node renovar-servidor3-12meses-correto.cjs <cliente_id>');
    console.log('📖 Exemplo: node renovar-servidor3-12meses-correto.cjs 648718886');
    process.exit(1);
}

// Executar renovação
renovar12MesesServidor3(clienteId).catch(console.error);
